...
!BOI
! !TITLE: {\huge{\sc The Elk Code Manual}}\\ \Large{\sc Version 8.7.10}\\ \vskip 20pt \includegraphics[height=1cm]{elk_silhouette.pdf}
...
!   Yunfan Liang, Xavier Gonze, Mike Bruckhoff and Eddie Harris-Lee. Special
...
!   Graz, the EU Marie-Curie Research Training Networks initiative, the Max Born
...
!
!   \vspace{12pt}
!   Berlin, Halle, Jerusalem and Uppsala, February 2023
!   \newpage
!
!   \section{Units}
